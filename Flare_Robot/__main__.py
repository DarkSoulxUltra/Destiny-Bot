...
FLARE_PHOTO = "https://telegra.ph/file/cb57c2af871c60bfdf732.jpg"
...
def start(update: Update, context: CallbackContext):
    ...
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_animation(
            GROUP_START_IMG, caption= "I won\'t sleep because I believe someone is waiting for your music.\n I\'m awake since :</b> <code>{}</code>".format(
                uptime
            ),
...
def main():
    ...
    if WEBHOOK:
        ...
        LOGGER.info("Unmei (Destiny) is deployed successfully!")
